...
CREATE TABLE IF NOT EXISTS users (
  ...
  admin_auth_version INT UNSIGNED NOT NULL DEFAULT 0 COMMENT '管理员登录会话版本',
  privacy_consent_version VARCHAR(32) DEFAULT NULL COMMENT '入驻个人信息授权版本',
  privacy_consent_at DATETIME DEFAULT NULL COMMENT '入驻个人信息授权时间',
...
CREATE TABLE IF NOT EXISTS experts (
  ...
  bio TEXT,
  profile_only TINYINT(1) NOT NULL DEFAULT 0,
