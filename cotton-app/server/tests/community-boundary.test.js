...
assert(dashboard.includes("window.open('/community/public'"), 'admin dashboard should expose the public platform')
assert(dashboard.includes("window.open('/community/business'"), 'admin dashboard should expose the business platform')
