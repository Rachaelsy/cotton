window.COTTON_SITE_DATA = {
  company: {
    ...
    shortName: '川月智能',
    phone: '021-66286003',
    email: 'lijiale@cyaia.cn',
    hours: '需求表单全天可填写',
    registeredAddress: '上海市浦东新区陆家嘴环路958号华能联合大厦3403A',
    serviceCoverage: '新疆喀什地区',
    serviceAreas: ['喀什市', '莎车县', '喀什地区各县']
  },
  ...
  products: [
    {
      ...
      visual: 'catalog-a-1',
      badge: '2025喀什试验品种',
      summary: '包衣棉种在售商品，品种曾纳入2025年喀什地区棉花品种对比试验；购买前须核对审定区域、批次标签和当地适宜性。',
      highlights: ['包衣棉种', '20kg/袋', '机采适配'],
      service: '支持加入购物车并在线提交订单。下单前请核对品牌、审定编号、检验批次、库存和配送范围。',
      price: 298,
      unit: '袋',
      stock: 60,
      sold: 0,
      ...
      sections: [
        {
          title: '商品介绍',
          body: '塔河2号包衣棉种按袋销售。商户应随商品提供审定编号、种子生产经营许可证、检验结果、发芽率和检疫信息，用户确认规格和数量后可在线下单。'
        },
        {
          title: '选种建议',
    ...
    },
    {
      ...
      name: '棉田复合肥 18-18-18 50kg',
      category: 'fertilizer',
      categoryName: '肥料营养',
      visual: 'catalog-a-2',
      badge: '均衡型配方',
      summary: '氮、磷、钾标示养分均衡的颗粒复合肥，适合作为棉田基肥或按测土方案配套使用。',
      highlights: ['18-18-18', '50kg/袋', '颗粒复合肥'],
      service: '支持在线选购和提交订单。下单前请确认品牌、执行标准、总养分、生产批次、库存及配送费用。',
      price: 188,
      unit: '袋',
      stock: 120,
      sold: 0,
      ...
      sections: [
        ...
        {
          title: '交易与使用说明',
          body: '网站提供商品浏览、数量选择、加入购物车、在线下单和订单查询服务。商品成交价格以订单确认页为准，具体配方和用量应结合地块检测及产品标签确定。'
        }
      ]
    },
    {
      id: 'seedling-water-soluble-fertilizer',
      name: '大量元素水溶肥 20-20-20+TE 20kg',
      category: 'fertilizer',
      categoryName: '肥料营养',
      visual: 'catalog-a-3',
      badge: '滴灌适用',
      summary: '均衡型大量元素水溶肥，适用于棉田滴灌追肥；具体用量应结合土壤、苗情和灌水计划确定。',
      highlights: ['20-20-20+TE', '20kg/袋', '全水溶'],
      service: '支持在线选购和提交订单。购买时请核对养分含量、氯离子标识、执行标准、生产批次和配送信息。',
      price: 168,
      unit: '袋',
      stock: 90,
      sold: 0,
    ...
    },
    {
      ...
      name: '70%吡虫啉水分散粒剂 100g',
      category: 'pesticide',
      categoryName: '植保产品',
      visual: 'catalog-a-4',
      badge: '登记信息必核',
      summary: '吡虫啉水分散粒剂在售商品。用于棉田前必须核对实物标签上的登记作物、防治对象、剂量和安全间隔期。',
      highlights: ['吡虫啉70%', '100g/袋', '水分散粒剂'],
      service: '支持在线选购和提交订单；农药由具备相应资质的商户销售，下单前须核对完整登记证号、标签信息和配送条件。',
      price: 38,
      unit: '袋',
      stock: 150,
      sold: 0,
    ...
    },
    {
      ...
      name: '聚乙烯棉田地膜 0.010mm',
      category: 'film',
      categoryName: '农膜材料',
      visual: 'catalog-b-1',
      badge: '棉田铺膜',
      summary: '聚乙烯农用地面覆盖薄膜，标示厚度0.010mm，幅宽和卷长可按棉花播种铺膜机型选择。',
      highlights: ['0.010mm', '聚乙烯', '幅宽可选'],
      service: '支持按卷在线购买。成交价格根据所选幅宽、卷长、克重及订单数量在订单确认页显示。',
      price: 186,
      unit: '卷',
      stock: 80,
      sold: 0,
    ...
    },
    {
      ...
      name: '单翼迷宫滴灌带 16mm×1000m',
      category: 'irrigation',
      categoryName: '滴灌材料',
      visual: 'catalog-b-2',
      badge: '水肥一体化',
      summary: '16mm单翼迷宫式滴灌带，单卷1000m，适配棉田地面滴灌；滴头间距、壁厚和流量下单时选择。',
      highlights: ['16mm管径', '1000m/卷', '规格可选'],
      service: '支持按卷在线购买。请选择壁厚、滴头间距和流量等对应规格，订单价格按所选规格和数量计算。',
      price: 328,
      unit: '卷',
      stock: 50,
      sold: 0,
    ...
    },
    {
      ...
      visual: 'catalog-b-3',
      badge: '滴灌首部配套',
      summary: '2英寸叠片式过滤器及基础连接组件，适用于小型棉田滴灌首部；过滤精度和设计流量需按系统核算。',
      highlights: ['2英寸接口', '叠片过滤', '可拆洗'],
      service: '支持按套在线购买。下单前请确认套装组件、过滤精度、接口形式、承压等级和配送信息。',
      price: 268,
      unit: '套',
      stock: 35,
      sold: 0,
    ...
    },
    {
      ...
      name: '花铃期高钾水溶肥 15-5-30+TE 20kg',
      category: 'fertilizer',
      categoryName: '肥料营养',
      visual: 'catalog-b-4',
      badge: '花铃期配方',
      summary: '高钾型大量元素水溶肥在售商品，适用于棉花花铃期按需滴灌追肥，具体方案需结合长势和土壤条件。',
      highlights: ['15-5-30+TE', '20kg/袋', '滴灌追肥'],
      service: '支持在线选购和提交订单。下单前请核对成分、执行标准、氯离子标识、生产批次和配送范围。',
      price: 176,
      unit: '袋',
      stock: 75,
      sold: 0,
    ...
    {
      id: 'xinluzhong-61-cotton-seed',
      name: '新陆中61号包衣棉种 20kg',
      category: 'seed',
      categoryName: '棉花种子',
      visual: 'catalog-c-1',
      badge: '南疆棉区品种',
      summary: '南疆棉区棉花品种商品，购买前须核对当年审定区域、种子标签、生产经营许可和检验批次。',
      highlights: ['包衣棉种', '20kg/袋', '批次可追溯'],
      service: '支持在线下单；实际供货以商家提交的种子审定、许可与批次资料为准。',
      price: 318,
      unit: '袋',
      stock: 45,
      sold: 0,
      merchantName: '平台商品库',
      specs: [['品种名称', '新陆中61号'], ['包装规格', '20kg/袋'], ['产品形态', '包衣棉种'], ['适用区域', '以审定公告及实物标签为准']],
      sections: [{ title: '选购说明', body: '种子属于重要农业投入品，下单前请核对审定编号、适宜种植区域、发芽率、净度、批次和检疫信息。' }]
    },
    {
      id: 'agricultural-urea-46',
      name: '农业用尿素 46% 50kg',
      category: 'fertilizer',
      categoryName: '肥料营养',
      visual: 'catalog-c-2',
      badge: '氮肥',
      summary: '颗粒尿素商品，适用于按土壤、苗情和滴灌施肥方案补充氮素，避免过量投入。',
      highlights: ['总氮≥46%', '50kg/袋', '颗粒型'],
      service: '支持在线下单；具体执行标准、生产批次和配送费用以订单信息为准。',
      price: 118,
      unit: '袋',
      stock: 180,
      sold: 0,
      merchantName: '平台商品库',
      specs: [['标示养分', '总氮≥46%'], ['包装规格', '50kg/袋'], ['产品形态', '颗粒'], ['施用方式', '按测土及水肥计划确定']],
      sections: [{ title: '使用提示', body: '棉田氮肥应分期、按需投入，并与磷钾肥和灌溉计划协同，避免前期旺长或后期贪青晚熟。' }]
    },
    {
      id: 'diammonium-phosphate-64',
      name: '磷酸二铵 64% 50kg',
      category: 'fertilizer',
      categoryName: '肥料营养',
      visual: 'catalog-c-3',
      badge: '氮磷肥',
      summary: '颗粒磷酸二铵商品，可用于棉田基肥配置；实际用量需结合土壤有效磷和整体施肥方案。',
      highlights: ['总养分64%', '50kg/袋', '颗粒型'],
      service: '支持在线下单；下单前请核对总养分、执行标准、批次标签和配送范围。',
      price: 245,
      unit: '袋',
      stock: 95,
      sold: 0,
      merchantName: '平台商品库',
      specs: [['标示总养分', '64%'], ['包装规格', '50kg/袋'], ['产品形态', '颗粒'], ['使用阶段', '以测土配方方案为准']],
      sections: [{ title: '使用提示', body: '磷肥投入需参考土壤检测和目标产量，避免仅凭经验重复施用；商品指标以实物包装标签为准。' }]
    },
    {
      id: 'humic-acid-water-soluble-fertilizer',
      name: '腐植酸水溶肥 20kg',
      category: 'fertilizer',
      categoryName: '肥料营养',
      visual: 'catalog-c-4',
      badge: '滴灌适用',
      summary: '含腐植酸水溶肥商品，可纳入棉田滴灌施肥方案，使用前应确认溶解性和管路兼容性。',
      highlights: ['20kg/袋', '水溶型', '滴灌施用'],
      service: '支持在线下单；含量、配方和执行标准以实际产品标签为准。',
      price: 158,
      unit: '袋',
      stock: 70,
      sold: 0,
      merchantName: '平台商品库',
      specs: [['包装规格', '20kg/袋'], ['产品形态', '水溶型'], ['适用系统', '滴灌施肥'], ['配伍要求', '使用前进行小范围兼容性试验']],
      sections: [{ title: '使用提示', body: '施用前确认水质、溶解性和过滤条件，结束后使用清水冲洗施肥罐与管路。' }]
    },
    {
      id: 'cotton-yellow-sticky-trap',
      name: '棉田诱虫黄板 25cm×20cm 20片',
      category: 'pesticide',
      categoryName: '植保产品',
      visual: 'catalog-d-1',
      badge: '虫情监测',
      summary: '棉田虫情监测与物理防控用品，可辅助观察有翅蚜、烟粉虱等害虫动态。',
      highlights: ['20片/包', '双面粘胶', '悬挂使用'],
      service: '支持在线下单；布设密度和更换周期应结合田间监测结果调整。',
      price: 26,
      unit: '包',
      stock: 220,
      sold: 0,
      merchantName: '平台商品库',
      specs: [['单片尺寸', '25cm×20cm'], ['包装规格', '20片/包'], ['使用场景', '虫情监测与物理防控'], ['布设方式', '结合棉株高度动态调整']],
      sections: [{ title: '使用提示', body: '黄板可用于辅助监测，不替代田间系统调查。达到防治指标后，应结合当地预报和绿色防控要求采取措施。' }]
    },
    {
      id: 'pe-irrigation-main-pipe-63',
      name: 'PE滴灌主管 63mm×100m',
      category: 'irrigation',
      categoryName: '滴灌材料',
      visual: 'catalog-d-2',
      badge: '输水主管',
      summary: '棉田滴灌输水用PE主管，公称外径63mm、单卷100m，壁厚和承压等级下单时选择。',
      highlights: ['63mm', '100m/卷', '承压可选'],
      service: '支持按卷在线购买；请按泵站流量、轮灌分区、距离和压力核算规格。',
      price: 365,
      unit: '卷',
      stock: 40,
      sold: 0,
      merchantName: '平台商品库',
      specs: [['公称外径', '63mm'], ['卷长', '100m'], ['材质', 'PE'], ['承压等级', '下单时按系统方案选择']],
      sections: [{ title: '选型提示', body: '主管管径和承压等级需根据设计流量、输水距离、地形高差与轮灌区规模计算，避免流量不足或超压。' }]
    },
    {
      id: 'drip-bypass-valve-16',
      name: '滴灌旁通阀 16mm 50只装',
      category: 'irrigation',
      categoryName: '滴灌材料',
      visual: 'catalog-d-3',
      badge: '田间配件',
      summary: '16mm滴灌带旁通连接阀，用于支管与滴灌带连接及分行控制，按50只包装销售。',
      highlights: ['16mm接口', '50只/包', '分行控制'],
      service: '支持在线下单；请核对滴灌带内径、支管开孔器及密封胶圈规格。',
      price: 68,
      unit: '包',
      stock: 130,
      sold: 0,
      merchantName: '平台商品库',
      specs: [['接口规格', '16mm'], ['包装数量', '50只/包'], ['适用场景', '支管与滴灌带连接'], ['配套要求', '开孔器及密封圈规格匹配']],
      sections: [{ title: '安装提示', body: '安装前清理毛刺并检查密封圈，通水后逐行检查渗漏和阀门启闭状态。' }]
    }
  ],
  ...
  machinery: [
    {
      ...
      category: 'land',
      categoryName: '耕整地',
      image: '/assets/service-land-preparation-v2.jpg',
    ...
    },
    {
      ...
      category: 'planting',
      categoryName: '播种铺膜',
      image: '/assets/service-seeding-mulching-v2.jpg',
      imagePosition: 'center',
      badge: '关键农时',
      stage: '播种期',
      billing: '按亩核定',
    ...
    },
    {
      ...
      category: 'protection',
      categoryName: '植保作业',
      image: '/assets/service-drone-protection-v2.jpg',
      imagePosition: 'center',
      badge: '适期作业',
      stage: '苗期至花铃期',
      billing: '按亩与作业方案核定',
    ...
    },
    {
      ...
      category: 'protection',
      categoryName: '植保作业',
      image: '/assets/service-interrow-management-v2.jpg',
      imagePosition: 'center',
      badge: '田间管理',
      stage: '苗期至蕾期',
      billing: '按亩或作业项目核定',
    ...
    },
    {
      ...
      category: 'harvest',
      categoryName: '采收作业',
      image: '/assets/service-cotton-harvest-v2.jpg',
      imagePosition: 'center',
      badge: '采收季',
      stage: '吐絮至采收期',
      billing: '按亩及地块条件核定',
    ...
    },
    {
      ...
      category: 'transport',
      categoryName: '田间转运',
      image: '/assets/service-cotton-transport-v2.jpg',
      imagePosition: 'center',
      badge: '采后衔接',
      stage: '采收后',
