...
首页今日待办保存在 `community_daily_todos`，使用具体日期、建议时间、标题、说明、播报文案、优先级、排序和发布状态管理。小程序通过 `GET /api/daily-todos?date=YYYY-MM-DD` 读取当天已发布事项；公共服务管理员通过 `/api/daily-todos/admin/*` 在后台维护内容。语音由小程序 WechatSI 插件生成，服务端不存储临时语音文件。
...
喀什优棉公共服务平台提供独立、可扩展的小程序管理员账号，不需要把账号提升为核心平台管理员。后台“政策资讯”统一管理政策中心与行业资讯，支持 Markdown 编辑和分类发布；“优棉金融”维护种植贷、棉花保险、期货基础和金融政策解读四篇 Markdown 文章；“首页推送”集中管理政策、行业、金融和首页专稿，最多同时推送 5 篇；“今日待办”按日期维护首页任务和语音文案；“专家讲堂”管理精选问答、在线专家与精选视频，并支持头像、封面和视频上传；“农机服务”和“农资服务”用于维护小程序中展示的具体产品目录；“加工服务”用于维护加工厂、地图坐标、产能、联系人、图片与发布状态。首次部署或更新后，容器启动会自动创建或升级管理员、文章、待办、专家和生产服务数据表。
...
公共服务小程序后台沿用核心管理员后台的视觉布局，但左侧导航按公共服务产品权限独立生成，目前提供“政策资讯”“优棉金融”“首页推送”“今日待办”“专家讲堂”“农机服务”“农资服务”“加工服务”“品种优选”“农户管理”和“账号安全”，不会暴露核心平台的商户、订单等菜单。
...
- 左侧目前提供“政策资讯”“优棉金融”“首页推送”“今日待办”“专家讲堂”“农机服务”“农资服务”“加工服务”“品种优选”“农户管理”和“账号安全”；政策资讯可选择政策中心/行业资讯及其分类，金融文章和首页推荐均由后台维护，今日待办按日期维护首页任务和播报文案，生产服务菜单管理具体上架内容和历年品种试验资料，账号安全可校验当前密码并设置高强度新密码。
...
- 公共服务管理员左侧同时提供“农户管理”，可查看、新增、编辑、启用和禁用共享数据库中的农户；核心后端采用独立的农户权限中间件，不向该账号开放商户、订单等其他平台接口。
