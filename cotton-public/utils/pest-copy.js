const PEST_COPY = {
  zh: {
    index: {
      ...
      aiBadge: 'AI 智能诊断',
      recognize: '拍照识别病虫害',
      recognizeSub: '拍摄棉花叶片、茎秆或虫体，快速获取识别结果与防治建议。',
      cameraAction: '立即拍照识别',
      album: '相册选择',
      albumSub: '从手机里选择已有图片',
      history: '识别历史',
      ...
      emptyHistoryHint: '快去拍照识别，守护棉田健康吧！',
      viewAll: '查看全部',
      viewMore: '查看更多',
      recentTitle: '最近识别',
      ...
      pendingCategory: '待确认',
      pendingSeverity: '待确认',
      photoFail: '无法打开相机，请稍后重试',
      albumFail: '无法打开相册，请稍后重试',
      recognizing: '正在扫描图片...',
  ...
  ug: {
    index: {
      ...
      emptyHistoryHint: 'رەسىم تارتىپ پاختا ئېتىزىنىڭ ساغلاملىقىنى قوغداڭ!',
      ...
      photoFail: 'كامېرانى ئاچقىلى بولمىدى، قايتا سىناڭ',
      albumFail: 'ئالبومنى ئاچقىلى بولمىدى، قايتا سىناڭ',
