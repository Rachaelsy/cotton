...
const COPY = {
  zh: {
    title: '实名认证', intro: '实名认证为可选服务，可用于需要身份核验的业务。证件资料仅用于平台审核。',
    ...
    approved: '实名认证已通过', approvedSub: '身份资料已核验，认证状态已经更新。',
  ...
  ug: {
    ...
    approved: 'دەلىللەشتىن ئۆتتى', approvedSub: 'كىملىك ئۇچۇرى تەكشۈرۈلدى، دەلىللەش ھالىتى يېڭىلاندى.',
